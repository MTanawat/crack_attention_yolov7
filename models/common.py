...
class Conv(nn.Module):
    ...
    def forward(self, x):
        ...
        # Print or inspect the input shape
    ...
    def forward_fuse(self, x):
        ...
        #print(f"Conv output shape (fuse): {out.shape}")
        return out
...
class Concat(nn.Module):
    ...
    def forward(self, x):
        #print(f"Concat input shapes before concatenation: {[t.shape if t is not None else 'None' for t in x]}")
        concatenated = torch.cat([t for t in x if t is not None], self.d)
